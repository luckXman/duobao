...
public abstract class AbstractLuckAddress implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractLuckAddress() {
	}

	/** minimal constructor */
	public AbstractLuckAddress(String account, String name, String province,
